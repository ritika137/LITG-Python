# -*- coding: utf-8 -*-
"""
Created on Sun Dec 17 12:41:42 2017
...
Warning: Desired error not necessarily achieved due to precision loss. in fmin_cg why?'''
#Y = Ynorm; '
...
#result = optimize.fmin_cg(cost_function, x0=myflat, fprime=gradient_vectorized, args=(Y,R,num_users,num_movies,
       #  num_features,myLambda),maxiter=50,disp=True,full_output=True)
result = minimize(fun=cost_function, x0=myflat, args=(Ynorm, R, num_features, myLambda),  
